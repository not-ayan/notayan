        ...
        <div className="w-full bg-background rounded-lg border border-border overflow-hidden">
          <div className="space-y-6">
            ...
            <div className="px-5 space-y-6">
              <div>
                <h1 className="text-2xl font-bold">LineageOS Extended</h1>
                        ...
                        <div>
                          ...
                          <ol className="list-decimal list-inside text-sm space-y-1">
                            ...
                            <li>Execute following commands
                              <pre className="bg-muted/50 p-2 mt-1 rounded-md">fastboot reboot fastboot{"\n"}fastboot flash vendor_boot vendor_boot.img</pre>
