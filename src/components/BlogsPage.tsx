...
// Markdown Blog Content Imports
import aulaF75Content from '../content/blogs/reverse-engineering-aula-f75.md?raw';
import fontPairingContent from '../content/blogs/font-pairing-guide.md?raw';
import vectorArtContent from '../content/blogs/vector-art-tips.md?raw';
import uiComponentsContent from '../content/blogs/ui-components.md?raw';
import fluidAnimationsContent from '../content/blogs/fluid-animations.md?raw';
...
const BLOG_POSTS: Post[] = [
  ...
  },
  {
    ...
    content: fluidAnimationsContent
  }
];
